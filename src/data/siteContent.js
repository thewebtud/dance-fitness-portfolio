...
export const instructorProfile = {
    ...
    features: [
        'Online and in-studio sessions',
        'Private choreography coaching',
        'Event performances and workshops',
    ],
    profileImage: {
        src: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=900&q=80',
        alt: 'Portrait placeholder for Sakshi profile photo',
    },
};
...
export const testimonialContent = {
    eyebrow: 'Client love',
    title: 'What dancers say after joining the groove',
};
...
export const testimonials = [
    ...
    {
        quote:
            'I booked a private routine for a family event and the choreography was elegant, energetic, and easy for everyone to learn.',
        author: 'Megha, bride-to-be',
    },
    {
        quote:
            'The online classes are structured so well that even through a screen you feel fully guided and motivated till the end.',
        author: 'Tanvi, remote client',
    },
];
